...
const socialLinks = [
  ...
  {
    href: "https://www.linkedin.com/in/rasamimananafetrafaneva",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.instagram.com/fetra_faneva",
    icon: (
      <svg
        width="25"
        height="24"
  ...
  return (
    <section id="contact" className="section bg-primary">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://getform.io/f/bwnylnva"
          method="POST"
          ...
          <div className=" md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="fetrafaneva@gmail.com"
                className="text-field"
              />
            </div>
          </div>
